...
- [ ] 1. Set up project structure and AWS CDK infrastructure
  - [ ] 1.1 Initialize CDK project with TypeScript
    ...
    - _Requirements: 8.2_
  - [ ] 1.2 Define core infrastructure stack
...
- [ ] 2. Implement document validation and metadata models
  - [ ] 2.1 Create shared types and interfaces
  ...
  - [ ] 2.3 Implement file type validation
...
- [ ] 4. Implement Document Lambda
  - [ ] 4.1 Create document upload handler
  ...
  - [ ] 4.6 Create document delete handler
    - Remove file from S3
  ...
  - [ ] 4.8 Create document list handler
    - List documents with pagination
    - Filter by metadata fields
    - _Requirements: 7.5, 7.6_

- [ ] 5. Checkpoint - Ensure document operations tests pass
  - Ensure all tests pass, ask the user if questions arise.
...
- [ ] 6. Implement authorization middleware
  ...
  - [ ] 6.3 Create authorization helper functions
...
- [ ] 7. Checkpoint - Ensure authorization tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 8. Implement Conversion Lambda
  - [ ] 8.1 Create Google Docs conversion handler
    - Fetch document via Google Docs API
    - Export as PDF
    - Store in S3
    - _Requirements: 1.4_
  - [ ] 8.2 Create PowerPoint conversion handler
    - Convert .pptx to PDF using LibreOffice Lambda layer
    - Store converted file in S3
    - _Requirements: 1.3_

- [ ] 9. Implement Search Lambda
  - [ ] 9.1 Create metadata search handler
  ...
  - [ ] 9.3 Create semantic search handler
    - Query Bedrock Knowledge Base
    - Return document references and text passages
    - Apply authorization filtering
    - _Requirements: 4.1, 4.3, 4.5_

- [ ] 10. Checkpoint - Ensure search tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 11. Set up Bedrock Knowledge Base infrastructure
  - [ ] 11.1 Create OpenSearch Serverless collection
    - Configure vector search collection
    - Set up access policies
    - _Requirements: 3.5, 8.3_
  - [ ] 11.2 Create Bedrock Knowledge Base
    - Configure S3 data source
    - Set up embedding model (Titan Embeddings V2)
    - Configure metadata indexing
    - _Requirements: 3.1, 3.2_

- [ ] 12. Implement API Gateway and wire components
  - [ ] 12.1 Create API Gateway REST API
    - Define all endpoints
    - Configure Cognito authorizer
    - Set up request/response mappings
    - _Requirements: 5.1_
  - [ ] 12.2 Connect Lambda functions to API Gateway
...
- [ ] 13. Implement metadata round-trip test
  - [ ]* 13.1 Write property test for metadata consistency
